# Generated by Django 2.0.1 on 2019-01-02 11:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('crawler', '0022_auto_20190102_1138'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='searchcriteria',
            name='fuel',
            field=models.CharField(choices=[('Dyzelinas', 'Dyzelinas'), ('Benzinas', 'Benzinas'), ('Benzinas / dujos', 'Benzinas / dujos'), ('Benzinas / elektra', 'Benzinas / elektra'), ('Elektra', 'Elektra'), ('Dyzelinas / elektra', 'Dyzelinas / elektra'), ('Dyzelinas / dujos', 'Dyzelinas / dujos'), ('Bioetanolis (E85)', 'Bioetanolis (E85)')], default=None, max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='searchcriteria',
            name='make',
